		...
		widgets = {
			{
				...
				sub_widgets = {
					...
					{ setting_id = "suppress_arc_maul",        type = "checkbox", default_value = true, title = "suppress_arc_maul",        tooltip = "suppress_arc_maul_tooltip" },
					{ setting_id = "suppress_galvanic_rifle",  type = "checkbox", default_value = true, title = "suppress_galvanic_rifle",  tooltip = "suppress_galvanic_rifle_tooltip" },
					...
					{ setting_id = "suppress_servo_skull_hum", type = "checkbox", default_value = true, title = "suppress_servo_skull_hum", tooltip = "suppress_servo_skull_hum_tooltip" },
